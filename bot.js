...
client.on('message', message => {
       if(message.content.startsWith(`*support`)){
           ...
           .setURL("https://discord.gg/NBG6WM7")
           .setTimestamp()
           .setColor("RANDOM")
   ...
   client.on('message', msg => {
     if(msg.content === 'n3k4a')
                 setTimeout(function() {
   msg.reply('غور ياض نعكشا بطل ينيك عيال')
                 }, 10000)
   });
   ...
   client.on('message', message => {
       ...
       client.on('message', async msg => {
         ...
         const searchMessage = await msg.channel.send('🖌️Painting by n3k4a not shiit ');
       ...
       client.on('message', message => {
        ...
        message.channel.send(alpha);
          ...
          const devs = ['456616044623298585' , '462006869834203159' , '' , ''];
          const adminprefix = "*";
          client.on('message', message => {
            ...
            if (message.content.startsWith(adminprefix + 'st')) {
              client.user.setGame(argresult, "https://www.twitch.tv/n3k4a");
                message.channel.sendMessage(`**✅   ${argresult}**`)
            }
            });
            ...
            client.on("message", (message) => {
                    ...
                    let yumz = new Discord.RichEmbed()
                                ...
                                .addField(`Sent By: n3k4a `, `<@${message.author.id}>`)
                                .setColor("RANDOM")
            ...
            const misaka = new Set();
              ...
              if (misaka.has(msg.author.id)) {
               ...
               client.on('message', message => {
                   ...
                   if(message.content.includes('n3k4a')){
                       message.delete()
                     message.channel.sendMessage("", {embed: {
                       title: "لا تسب",
                       color: 0x06DF00,
                       description: "واحد بس عليك يا جلال",
                       footer: {
                         text: "By n3k4a"
                       }
      ...
      client.on('guildMemberAdd', member => {
       ...
       return channel.send("**`سيرفر  للمحترفين و الجيمر` \n [https://discord.gg/etHcMvw]**")
          }
          )});
    ...
    if (message.content === '*invite') {
           ...
           .setThumbnail(message.author.avatarURL)
           .addField("**رابط اضافه البوت**","**[https://discordapp.com/api/oauth2/authorize?client_id=497489044591214593&permissions=8&scope=bot] **")
           .setColor('RANDOM')
     ...
     if (message.member.voiceChannel == null) return message.channel.send(`**الرجاء الدخول لروم صوتي**`)
      ...
      message.channel.send(`**تم سحب جميع الأعضاء الي الروم الصوتي حقك.**`)
        ...
        client.on('guildDelete', guild => {
          client.channels.get("495240795406860308")
        const embed = new Discord.RichEmbed()
...
Members : __${guild.memberCount}__
        Servers Counter : __${client.guilds.size}__**`)
                 ...
                 .setFooter('SmartBot' , client.user.avatarURL)
                   client.channels.get("495240795406860308").send({embed});
        }
